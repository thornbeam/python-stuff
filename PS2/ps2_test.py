...
def get_best_path(digraph, start, end, path, max_dist_outdoors, best_dist, best_path, toPrint=False):
    """
    ...
    if start not in digraph.nodes:
        ...
        for node in digraph.get_edges_for_node(start):
            if node.dest not in path:
                    new_path = get_best_path(digraph, node.dest, end, path, max_dist_outdoors, best_dist, best_path, toPrint)
                    if new_path != None:
                        ...
                        if outdoor_dist <= max_dist_outdoors and total_dist <= best_dist:
                            ...
                            if toPrint:
                                print("current best distance:", best_dist)
    return best_path
...
def directed_dfs(digraph, start, end, max_total_dist, max_dist_outdoors):
    ...
    best_path = get_best_path(digraph, start, end, [], max_dist_outdoors, max_total_dist, None, True)
